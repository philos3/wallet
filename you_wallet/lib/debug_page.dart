...
//    debugPrint(filePath);
  ...
  Future<Null> _authenticate() async {
    ...
    final snackBar =
        new SnackBar(content: new Text(authenticated ? '验证通过' : '验证失败'));
...
//            ),
              ...
              FlatButton(
                ...
                onPressed: () async {
                  ...
                  print(encryptText);
                  //解密
                  var decryptText = await FlutterAesEcbPkcs5.decryptString(
                      encryptText, hex.encode(digest.bytes));
              ...
              FlatButton(
                ...
                onPressed: () async {
                  ...
                  final private =
                      EthPrivateKey.fromHex(bytesToHex(child1.privateKey));
